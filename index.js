...
function buildResponse(base64) {
  var oldState = base64 ? decodeState(base64) : defaultState;
  return {
    statusCode: 200,
    headers: {
      "content-type": "text/html"
    },
    body: (0, _server.renderToString)( /*#__PURE__*/_react["default"].createElement(TurnForm, {
...
function _handler() {
  _handler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event, context, callback) {
    var base64, baseUrl;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          base64 = event.rawPath.substring(1);
